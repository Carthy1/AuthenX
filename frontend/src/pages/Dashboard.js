...
const getGreeting = () => {
  const date = new Date();
  // Workaround for sandboxed VM environments where the system clock timezone is set to UTC-12
  // but the user's actual time matches UTC/GMT (Ghana).
  ...
  return (
    <>
      <div style={{ marginBottom: "30px" }}>
        <h2 style={{ fontSize: "28px", margin: 0 }}>{isSuperAdmin ? "AuthenX Global Command" : `${getGreeting()}, ${user.fullName}`}</h2>
          ...
          <div style={{ width: "100%", height: "250px" }}>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="verified" name="Verifications" stroke="#2563eb" strokeWidth={3} fillOpacity={1} fill="url(#colorVerify)" />
                <Area type="monotone" dataKey="issued" name="Certificates Issued" stroke="#d97706" strokeWidth={3} fillOpacity={1} fill="url(#colorIssue)" />
              </AreaChart>
            </ResponsiveContainer>
            }
          </div>
      ...
      <div className="grid-2-1" style={{ marginTop: "25px" }}>
        
        <div className="chart-container" style={{ margin: 0 }}>
          <h4 style={{ margin: "0 0 20px 0", display: "flex", alignItems: "center", gap: "10px" }}><Database size={18} color="var(--primary)"/> Top 5 Degrees Minted</h4>
          <div style={{ width: "100%", height: "250px" }}>
            {loading ? <div className="shimmer" style={{ width: "100%", height: "100%" }}></div> : 
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="chart-container" style={{ margin: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <div style={{ padding: "12px", background: "rgba(255,255,255,0.03)", borderRadius: "10px", borderLeft: "3px solid var(--primary)" }}>
  ...
  return (
    <div>
      ...
      <div className="section-card" style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "40px 20px" }}>
        ...
        {status && (
          <div style={{ marginTop: "25px", padding: "10px 20px", borderRadius: "20px", background: status.includes("Verified") ? "rgba(46, 204, 113, 0.1)" : status.includes("Querying") ? "rgba(243, 156, 18, 0.1)" : "rgba(231, 76, 60, 0.1)", color: status.includes("Verified") ? "#2ecc71" : status.includes("Querying") ? "#f39c12" : "#e74c3c", display: "flex", alignItems: "center", gap: "8px", fontWeight: "bold" }}>
             {status.includes("Verified") ? <CheckCircle size={18}/> : status.includes("Querying") ? <Clock size={18}/> : <XCircle size={18}/>}
             {status}
          </div>
        )}
...
const TrustCouncil = ({ user }) => {
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "25px" }}>
        <h2 style={{ display: "flex", alignItems: "center", gap: "10px", margin: 0 }}><ShieldAlert color="#e74c3c" size={28} /> Target Governance (SuperAdmin)</h2>
      ...
      <div className="grid-3" style={{ marginBottom: "30px" }}>
        <div className="section-card metric-card" style={{ padding: "20px", display: "flex", alignItems: "center", gap: "15px" }}>
          ...
          <div><p style={{ margin: 0, fontSize: "13px", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>GTEC Accredited (Pending Node)</p>
        ...
        <div className="section-card metric-card" style={{ padding: "20px", display: "flex", alignItems: "center", gap: "15px" }}>
          ...
          <div><p style={{ margin: 0, fontSize: "13px", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>Active Blockchain Nodes</p>
...
const GtecPortal = ({ user }) => {
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "25px" }}>
        <h2 style={{ display: "flex", alignItems: "center", gap: "10px", margin: 0 }}><ShieldAlert color="var(--accent)" size={28} /> GTEC Accreditation Terminal</h2>
        <div style={{ position: "relative", width: "300px" }}>
          <Search size={18} color="var(--text-muted)" style={{ position: "absolute", left: "15px", top: "14px" }} />
          <input 
            type="text" 
      ...
      <div className="grid-3" style={{ marginBottom: "30px" }}>
        <div className="section-card metric-card" style={{ padding: "20px", display: "flex", alignItems: "center", gap: "15px" }}>
          <div style={{ background: "rgba(217, 119, 6, 0.1)", padding: "15px", borderRadius: "12px", color: "var(--accent)" }}><Clock size={32} /></div>
          <div><p style={{ margin: 0, fontSize: "13px", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>Awaiting GTEC Audit</p>
          <h3 style={{ margin: "5px 0 0 0", fontSize: "28px" }}>{pendingApps.length}</h3></div>
        </div>
        <div className="section-card metric-card" style={{ padding: "20px", display: "flex", alignItems: "center", gap: "15px" }}>
          <div style={{ background: "rgba(5, 150, 105, 0.1)", padding: "15px", borderRadius: "12px", color: "var(--success)" }}><ShieldCheck size={32} /></div>
          <div><p style={{ margin: 0, fontSize: "13px", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>GTEC Accredited</p>
          <h3 style={{ margin: "5px 0 0 0", fontSize: "28px" }}>{accreditedApps.length}</h3></div>
        </div>
        <div className="section-card metric-card" style={{ padding: "20px", display: "flex", alignItems: "center", gap: "15px" }}>
          <div style={{ background: "rgba(220, 38, 38, 0.1)", padding: "15px", borderRadius: "12px", color: "var(--danger)" }}><XCircle size={32} /></div>
          <div><p style={{ margin: 0, fontSize: "13px", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>Accreditation Declined</p>
          <h3 style={{ margin: "5px 0 0 0", fontSize: "28px" }}>{suspendedApps.length}</h3></div>
        </div>
      </div>
...
const CreateUser = ({ user }) => {
  ...
  const fetchStaff = () => {}; // Deprecated: Real-time listener implemented below
    ...
    <div>
      ...
      <div className="grid-1-2">
        ...
        <div className="section-card" style={{ alignSelf: "start" }}>
          ...
          {status && <div style={{ marginTop: "15px", padding: "10px", borderRadius: "10px", background: status.includes("successfully") ? "rgba(46, 204, 113, 0.1)" : status.includes("Registering") ? "rgba(243, 156, 18, 0.1)" : "rgba(231, 76, 60, 0.1)", color: status.includes("successfully") ? "#2ecc71" : status.includes("Registering") ? "#f39c12" : "#e74c3c", fontSize: "14px", fontWeight: "600", textAlign: "center" }}>{status}</div>}
        </div>
  ...
  const issueBatchToBlockchain = async () => {
    ...
    try {
      ...
      for (let i = 0; i < parsedData.length; i++) {
        ...
        setBatchProgress(`Minting Record for ${sName}... Please confirm in wallet.`);
        ...
        <div className={`sidebar ${isMobileMenuOpen ? "open" : ""}`}>
          <div style={{ textAlign: "center", marginBottom: "30px", position: "relative" }}>
            {user?.role === "superadmin" || user?.role === "gtec" ? (
               <div style={{ width: "160px", height: "160px", borderRadius: "50%", background: "rgba(37, 99, 235, 0.08)", border: "2px solid var(--primary)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", color: "var(--primary)", boxShadow: "0 10px 20px rgba(0,0,0,0.3)", margin: "0 auto", marginBottom: "15px" }}>
                  <ShieldAlert size={50} />
                  <span style={{ fontSize: "16px", fontWeight: "bold", marginTop: "10px", color: "var(--text-main)", textAlign: "center", padding: "0 5px" }}>
                    {user?.role === "superadmin" ? "AuthenX Core" : "GTEC Registry"}
                  </span>
               </div>
            ) : (
               <label style={{ cursor: isAdmin ? "pointer" : "default", display: "inline-block" }}>
                 {schoolLogo ? (
                   ...
                   <div style={{ width: "160px", height: "160px", borderRadius: "50%", background: "rgba(37, 99, 235, 0.08)", border: "2px dashed var(--primary)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", color: "var(--primary)", marginBottom: "15px", margin: "0 auto", opacity: logoUploading ? 0.5 : 1 }}>
